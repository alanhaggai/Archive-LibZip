...
is( $lz->find( 'B',   ZIP_FL_NOCASE | ZIP_FL_NODIR ), 1,
    'file matched (case insensitive, no directory)' );
...
is( $lz->comment(), 'This is a .ZIP archive for tests against Archive::LibZip',
    'comment' );
